...
public class MathUtility implements TypeHandlerUtility {
    ...
    @Override
    public boolean checkDataType(final Literal... args) {
        return checkNumericDatatype(args);
    }

    @Override
    public NumericIV performOperation(final Literal l1, final IV iv1,
