...
import com.bigdata.rdf.internal.constraints.TypeHandlerUtility;
...
public class LexiconConfiguration<V extends BigdataValue>
    ...
    /**
     * The set of registered {@link TypeHandlerUtility}s.
     */
    private static final ArrayList<TypeHandlerUtility> typeHandlers = new ArrayList<TypeHandlerUtility>();
...
//            final BigdataURI datatype = extension.getDatatype();
        	...
        	if (extension instanceof TypeHandlerUtility) {
        	    typeHandlers.add((TypeHandlerUtility)extension);
        	}
...
//        }
    ...
    public Collection<TypeHandlerUtility> getTypeHandlers() {
        return typeHandlers;
    }
}
